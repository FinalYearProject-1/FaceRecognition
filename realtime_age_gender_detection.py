#As the filename suggests that the model should show gender and age both
#but if for some reason the age is not shown coorectly
#then omit the part : +age+"yrs" from the code at line 106
...
while True:
    ...
    for index,current_face_location in enumerate(all_face_locations):
        ...
        #change the position agnitude to fit the actual size video frame
        top_pos = top_pos*4
        ...
        #Predicting Age
        #declaring the labels
        age_label_list = ['(0-2)', '(04-6)', '(8-12)', '(15-20)', '(25-32)', '(38-43)', '(48-53)','(60-100)' ]
        ...
        #find the max value of predictions index
        #pass index to label array and get the label text
        age = age_label_list[gender_predictions[0].argmax()]
        ...
        cv2.putText(current_frame, gender+" "+age+"yrs", (left_pos,bottom_pos+25), font, 1, (25,255,25),1)
