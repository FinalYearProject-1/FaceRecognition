...
# [number_of_times_to_upsample=2 --> 1 ] @line44

#to increase the accuracy we can copy the below 2 lines(13 & 14) of code to input more Modi images
#also we'll have to make corrections @line27 also
