#to check the faces in different images 
#change the path of the image @line11 & line25

#to get more accuracy we can change the model from 'hog' --> 'cnn' also @line30
...
original_image = cv2.imread('images/testing/trump-modi.jpg')
...
for current_face_location, current_face_encoding in zip(all_face_locations, all_face_encodings):
    ...
    cv2.rectangle(original_image,(left_pos,top_pos),(right_pos,bottom_pos),(25,255,25),2)
    
    #display the name as text in the image
    font = cv2.FONT_HERSHEY_DUPLEX
    cv2.putText(original_image, name_of_person, (left_pos,bottom_pos+25), font, 0.5, (255,255,255),1)
