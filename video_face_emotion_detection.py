...
#load the video and load the weights
...
while True:
    ...
    for index,current_face_location in enumerate(all_face_locations):
        ...
        cv2.putText(current_frame, emotion_label, (left_pos,bottom_pos), font, 1, (25,255,25),1)
        
    #display the video
    #cv2.putText("Webcam Video",current_frame)    
